\begin{bclogo}[barre=none,logo={}]{Contraction du texte} 
	\begin{center}
		\subsubsection*{{L’entreprise altruiste.}}\addcontentsline{toc}{subsection}{20220729 - Contraction de texte (AS 2021)}
	\end{center}
\end{bclogo}
